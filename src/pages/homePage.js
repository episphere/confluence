        ...
        <div class="secondary-bg padding-bottom-1rem">
            ...
            <div class="container align-middle text-center" style="margin-top: 70px;">
                <div class="card-deck" id="infoDeck" style="min-height: 200px;">`
                    ...
                    template += cardContents({header: 'Participating Consortium', button: 'Join a Consortia', href: '#join', icon: 'fa-chart-bar', explanation: 'Learn about the consortia particiapting in Confluence.'})

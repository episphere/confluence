        ...
        <div class="secondary-bg padding-bottom-1rem">
            ...
            <div class="container align-middle text-center" style="margin-top: 70px;">
                <div class="row" id="infoDeck" style="min-height: 200px;">`
                    ...
                    template += cardContents({header: 'Data Dictionary', button: 'Data dictionary', href: '#data_exploration/dictionary', icon: 'fa-book', explanation: 'View variables from participating studies.'})
                    template += `
                </div>
            </div>
        </div>

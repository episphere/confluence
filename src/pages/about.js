            ...
            <div class="container">
                <div class="main-summary-row white-bg div-border">
                    <ul class="nav nav-pills">
                        ...
                        ${showDescripton ? `<li class="nav-item"><a class="nav-link black-font font-size-14" href="#join/overview"><strong>Consortium</strong></a></li>`:``}
                        ${showDescripton ? `<li class="nav-item"><a class="nav-link black-font font-size-14" href="#join/description"> <strong>DACCs</strong></a></li>`:``}

            ...
            <div class="container body-min-height">
                ...
                <div class="data-submission div-border font-size-18" style="padding-left: 1rem;">             
                    <section class="contact-form">
                        <p> 
                            Please fill out the form below. This will be reviewed by the Data Access Coordination Committees (DACC) 
                            ...
                            <form>
                                <div class="input-group">
                                    <label for="date">
                                        <b>Date</b><span class='required-label'>*</span>
                                    </label>
                                    <input id="date" name="date" type="date" value='${today}' required/>
                                </div>
                                <div class="input-group">
                                    <label for="projname">
                                        <b>Title of Proposed Project</b><span class='required-label'>*</span>
                                    </label>
                                    <input id="projname" name="projname" type="text" required/>
                                </div>
                                <div class="input-group form-check">
                                    <label for="amendment">
                                        <b>Is this an amendment?</b><span class='required-label'>*</span> 
                                    </label>
                                ...
                                <div class="input-group">
                                    <label for="investigators">
                                        <b>Contact Investigator(s)</b><span class='required-label'>*</span>
                                    </label>
                                ...
                                <div class="input-group">
                                    <label for="institution">
                                        <b>Institution</b><span class='required-label'>*</span>
                                    </label>
                                ...
                                <div class="input-group">
                                    <label for="email">
                                        <b>Contact E-mail</b><span class='required-label'>*</span>
                                    </label>
                                ...
                                <div class="input-group">
                                    <label for="mem-con">
                                        <b>Member of Consortia or Study / Trial Group?</b><span class='required-label'>*</span>
                                    </label>
                                </div>
                                <div class="input-group">
                                    <div class="container-lg">
                                        ...
                                        <div class="input-group">
                                            <label for="allinvest">
                                                <b>ALL Investigators (and their institutions) who will require access to the data requested</b><span class='required-label'>*</span>
                                            </label>
                                            <textarea id="allinvest" name="allinvest" rows="2" cols="65" required></textarea>
                                            <p>
                                                <b>Note:</b> Datasets cannot be exchanged between institutions. See the data access request procedures for more information.
                                            </p>
                                        </div>
                                        <div class="input-group">
                                            <label>
                                                <input id="confirmation" name="confirmation" type="checkbox" value="Yes" required/><b> Please confirm that ALL the named investigators have read AND agreed to be named on this proposal?</b><span class='required-label'>*</span>
                                            </label>
                                        </div>
                                        <div class="input-group">
                                            <label for="data-con"><b>Consortia or Study / Trial Group data being requested</b>
                                                <span class='required-label'>*</span> <i>(please check all boxes that apply)</i>
                                            </label>
                                        </div>
                                        <div class="input-group">
                                            <div class="container-lg">
                                        ...
                                        <div class="input-group">
                                            <label for="analdesc">
                                                <b>Description of Analysis Plan</b> <i> Please provide a concise description of your Analysis Plan</i><span class='required-label'>*</span>
                                            </label>
                                            <textarea id="analdesc" name="analdesc" rows="6" cols="65" required></textarea>
                                        </div>
                                        <div class="input-group">
                                            <label for="prim-end">
                                                <b>Primary Endpoint</b><span class='required-label'>*</span><i> (please check box)</i> 
                                            </label>
                                        </div>
                                        <div class="input-group">
                                            <div class="container-lg">
                                        ...
                                        <div class="input-group">
                                            <div class="container-lg">
                                                ...
                                                <div class="col-12 col-md-12 col-sm-12">
                                                    ...
                                                    <p> 
                                                        <br>If specific variants are being requested, please complete and attach the following manifest (download the manifest template here). Please use build 38 to denote variants.
                                                    </p>
                                    ...
                                    <div class="input-group">
                                        <div class="container-lg">
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-sm-12">
                                                    <p>
                                                        <i>BRCA1</i> and <i>BRCA2</i> carrier status can be made only from CIMBA, and from some MERGE participants. Carrier 
                                                        status information is not routinely collected from studies participating in AABCG, BCAC, C-NCI, or LAGENO.
                                                    </p>
                                                    <div class="form-check form-check-inline">
                                    ...
                                    <div class="input-group">
                                        <p>
                                            All data requests will be provided access to the Confluence core variables. Please select the variable category needed for the proposed project. 
                                            ...
                                            The data analysis plan should describe why the variables are being requested.
                                        </p>
                                    </div>
                                    <div class="input-group">
                                ...
                                <div class="input-group">
                                    <u id="tooltip1">
                                        <a>
                                            <label>
                                                <input id="confirmationAuth" name="confirmationAuth" type="checkbox" value="Yes" required/> 
                    ...
                    children: [
                        ...
                        new docx.Paragraph({
                            ...
                            children: [
                                ...
                                new docx.TextRun({
                                    text: JSON.stringify(jsondata.primend, null, 1).replace("[", "").replace("]", "").replace(/"/g, ''),
                                    bold: false
                                })
                            ],
                            spacing: {
                        ...
                        new docx.Paragraph({
                            ...
                            children: [
                                ...
                                new docx.TextRun({
                                    text: JSON.stringify(jsondata.genotyping, null, 1).replace("[", "").replace("]", "").replace(/"/g, ''),
                                    bold: false
                                })
                            ],
                            spacing: {
                        ...
                        new docx.Paragraph({
                            ...
                            children: [
                                ...
                                new docx.TextRun({
                                    text: JSON.stringify(jsondata.sex, null, 1).replace("[", "").replace("]", "").replace(/"/g, ''),
                                    bold: false
                                })
                            ],
                            spacing: {
                        ...
                        new docx.Paragraph({
                            ...
                            children: [
                                ...
                                new docx.TextRun({
                                    text: JSON.stringify(jsondata.carStatus, null, 1).replace("[", "").replace("]", "").replace(/"/g, ''),
                                    bold: false
                                })
                            ],
                            spacing: {
                        ...
                        new docx.Paragraph({
                            ...
                            children: [
                                ...
                                new docx.TextRun({
                                    text: JSON.stringify(jsondata.riskfactvar, null, 1).replace("[", "").replace("]", "").replace(/"/g, ''),
                                    bold: false
                                })
                            ],
                            spacing: {

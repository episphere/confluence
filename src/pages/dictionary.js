            ...
            <div class="col-md-12">
                <div class="row ps-3 pe-5">
                    <div class="col-md-3 font-bold">
                        Variable <button class="transparent-btn sort-column" data-column-name="Variable"><i class="fas fa-sort"></i></button>
                    </div>
                    <div class="col-md-5 font-bold">
                        Label <button class="transparent-btn sort-column" data-column-name="Label"><i class="fas fa-sort"></i></button>
                    </div>
                    <div class="col-md-2 font-bold">
                        Category <button class="transparent-btn sort-column" data-column-name="Category"><i class="fas fa-sort"></i></button>
                    </div>
                    <div class="col-md-2 font-bold">
                        Data Type <button class="transparent-btn sort-column" data-column-name="Data Type"><i class="fas fa-sort"></i></button>
                    </div>
                </div>
            </div>
        </div>
...
export const updateDict = () => {
    ...
    updateDictButton.addEventListener('click', async e => {
        ...
        header.innerHTML = `
            <h5 class="modal-title">New Dictionary Download</h5>

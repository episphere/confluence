    ...
    return `
        <div class="row footer-content">
            <div class="col content-wrapper">
                <ul class="menu">
                    <li class="menu-item links-border-right"><a class="footer-links" href="https://dceg.cancer.gov/research/cancer-types/breast-cancer/confluence-project">DCEG Confluence</a></li>
